...
def multiline_chart(rows, dtypes_values, x_name, y_names):
    return mat_funcs.multiline_chart(rows, dtypes_values, x_name, y_names)
# .........
def single_line_chart(rows, x_name, y_values, dtypes_values=None):

    return mat_funcs.single_line_chart(rows, x_name, y_values, dtypes_values)

# .........
def single_scatter_plot(rows, x_name, y_values, dtypes_values=None, trend_line=True):
    return mat_funcs.single_scatter_plot(rows, x_name, y_values, dtypes_values, trend_line)

# .........

def histogram(rows, x_name, y_values, dtypes_values=None):
    return mat_funcs.histogram(rows, x_name, y_values, dtypes_values)

# ..........

def pie_chart(rows, x_name, y_values, dtypes_values=None):
    return mat_funcs.pie_chart(rows, x_name, y_values, dtypes_values)

# .........

def bar_chart(rows, x_name, y_values, dtypes_values=None):
    return mat_funcs.bar_chart(rows, x_name, y_values, dtypes_values)
